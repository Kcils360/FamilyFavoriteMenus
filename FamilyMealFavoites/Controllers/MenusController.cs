...
namespace FamilyMealFavoites.Controllers
{
    public class MenusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,DishName,AvgRating")] Menu menu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,DishName,AvgRating")] Menu menu)
        {
            if (id != menu.ID)
            {
                return NotFound();
